...
When a credit application is rejected (negative prediction), counterfactuals are generated and labeled as approved (positive class). This strategy provides surrogate models with additional decision boundary information, improving their ability to mimic the target model's behavior.
